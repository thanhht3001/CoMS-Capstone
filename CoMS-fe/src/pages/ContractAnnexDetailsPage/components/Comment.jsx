...
function Comment() {
  ...
  const fetchComments = async () => {
    try {
      const response = await fetch(
        `https://localhost:7073/Comments/annex?contractAnnexId=${contractAnnexId}&CurrentPage=1&PageSize=10`,
        {
          mode: "cors",
          method: "GET",
          headers: new Headers({
  ...
  const fetchNext = async () => {
    ...
    const res = await fetch(`https://localhost:7073/Comments/annex?contractAnnexId=${contractAnnexId}&CurrentPage=${currentPage + 1}&pageSize=10`, {
      mode: 'cors',
      method: 'GET',
      headers: {
        Authorization: `Bearer ${token}`,
