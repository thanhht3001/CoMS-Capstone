...
function List() {
  ...
  const fetchContractAnnexData = async () => {
    let url = `https://localhost:7073/ContractAnnexes/yours?IsYours=true&CurrentPage=1&PageSize=10`;
  ...
  const fetchNext = async () => {
    ...
    const res = await fetch(
      `https://localhost:7073/ContractAnnexes/yours?IsYours=true&CurrentPage=${
        currentPage + 1
      }&pageSize=10`,
      {
        mode: "cors",
  ...
  const handleKeyDown = async (e) => {
    if (e.key === "Enter") {
      let url = `https://localhost:7073/ContractAnnexes/yours?IsYours=true&CurrentPage=1&PageSize=10&ContractAnnexName=${searchByName}`;
      const res = await fetch(url, {
        mode: "cors",
        method: "GET",
        headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    setIsFilterOpen(false);
    let url = `https://localhost:7073/ContractAnnexes/yours?IsYours=true&ContractAnnexName=${contractAnnexName}&CurrentPage=1&PageSize=10`;
